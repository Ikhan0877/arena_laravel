...
@section ('content')
    <section class="courses-bg-banner">
        <div class="courses-bg-banner-wrapper">
           <div class="courses-main-content pl-5">
                <div>
                    <h1 class="text-white">Top Courses</h1>
                    <p class="text-white">Search for top courses.</p>
                </div>
                <div>
                    <div class="d-flex  justify-content-center align-content-center p-2 w-75">
                        <a href="" class="h6 p-2 bg-light mr-1">ANIMATION</a>
                        <a href="" class="h6 p-2 bg-light mr-1">GRAPHICS</a>
                        <a href="" class="h6 p-2 bg-light mr-1">DIGITAL </a>
                    </div>
                </div>
           </div>
        </div>
    ...
    <section class="container mt-5">
        ...
        <section class="row mt-3">
            ...
            <div class="col-md-4 mt-3 col-6">
                <div class="">
                    <div class="w-100 rounded-sm" style="background-image:url('images/course-image/bsc.png');height:300px;background-size:cover;border-radius:10px;">
                    </div>
                    <div class="course-nav-cont">
                            <a class="button secondary url" href="{{ url('courses/degree/bsc-in-graphics-and-vfx') }}"><h2 class="text-dark h5">Bsc in Graphics</h2></a><br>
                            <span>12 months</span>
                    </div>
                </div>
            </div>
