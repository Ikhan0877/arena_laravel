...
@section ('content')
    ...
    <div class="course-term-title-wrapper w-100 px-5 px-md-5 mb-5">
                <div class="corse-term-title">
                        <h1 class="text-dark font-weight-bold h1">GRAPHICS, WEBDESIGN AND <span class="text-orange">DEVELOPMENT</span></h1>
    ...
    <section class="course-term mb-5 course-term-wrapper">
        ...
        <div class="course-term-content-wrapper ml-5" >
            <div class="course-term-nav py-3">
                <span class="h5 font-weight-bold p-2"> <a href="#web-designing-term1" class="text-dark">TERM 1 </a> </span>
                <span class="h5 font-weight-bold p-2"> <a href="#web-designing-term2" class="text-dark">TERM 2 </a> </span>
            </div>
            <div class="owl-carousel owl-theme course-term-content py-4" id="courses-term-content">
                <div class="item" data-hash="web-designing-term1">
                    <p >
                ...
                <div class="item" data-hash="web-designing-term2">
                    <p >
                    Desigining for Web using Markup Languages and Style sheets,
                    Concepts of Programming,
                    Web Development using AgularJS,
    ...
    <section class="course-term-completion px-5" style="margin-bottom:100px;">
        <div>
