...
@section ('content')
    ...
    <div class="course-term-title-wrapper  w-100 px-5 px-md-5 mb-5">
        <div class="corse-term-title">
                <h1 class="text-dark font-weight-bold h1">G W D - PRINT & PUBLISH</span></h1>
    ...
    <section class="w-75 pl-5 mb-5 course-term-description">
        ...
        <div class="course-term-content-wrapper ml-5" >
            ...
            <div class="owl-carousel owl-theme course-term-content py-4" id="courses-term-content">
                <div class="item" data-hash="digital-marketing-term1">
                    <p >
                    Design and Visualisation Fundamentals,
                    Graphic and Illustration Fundamentals,
                    Typography Techniques,
                    Creative Illustrations,
                    Image MAgic with Photoshop CC,
                    Designs for Print and Advertising,
                    Media Publishing,
                    Print Porfolio
                    </p>
                </div>             
